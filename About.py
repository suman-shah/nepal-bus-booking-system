...
l2=Label(frame3,text='This project is made with the help of all friends of the batch 2075',font=('Arial',10,'bold')).grid(row=0,column=0)
img_bus=PhotoImage(file='bus-2028647_640.png')
bus_lab=Label(frame3,image=img_bus).grid(row=0,column=2)
